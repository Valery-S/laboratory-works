...
Graph mutation(Graph gr,int& flag) {//мутация наилучшей особи
	...
	//Мутация проиходит у той особи, длина пути которой меньше(первой), чтобы достичь ещё меньшей длины. 
	...
	//Иначе присваиваем переменной flag, переданной как параметр значение равное 0 - показатель неуспешной мутации
	if (sum_n < sum_f) { 
